...
export const seedDatabase = async () => {
  ...
  await Task.insertMany([
    ...
    },
    {
      projectId: coreProject._id,
      sprintId: sprints[0]._id,
      title: "Fix invitation system membership sync",
      description: "Ensure invites always record the correct inviter, accept/decline updates reliably, and accepted invites add the project to the user profile.",
      assignedTo: byCode["BCN-0001"]._id,
      priority: "HIGH",
      storyPoints: 5,
      status: "TODO",
      risk: { score: 0.46, level: "MEDIUM" },
      businessValue: 8,
      riskFactor: 7,
      urgency: 9,
    },
